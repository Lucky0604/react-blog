...
export default class Article extends Component {
    ...
    render() {
        ...
        if (articleProps.data && articleProps.data.data) {
            let {blogInfo} = props.layout.data.data,
                    ...
                    <section className="comment">
                                    ...
                                    return (
                                        <li key={i}>
                                            <div className="info">
                                                ...
                                                <strong>{comment.user && comment.user.name || comment.admin && comment.admin.name}</strong>
                        ...
                        <table>
                            ...
                            <tr>
                                <td>&nbsp;</td>
                                <td>
                                    <a href="javascript: void(0)" onClick={this.handleSubmit.bind(this, {id: article._id, typePath: article.type})} className="btn">发表评论</a>&nbsp;&nbsp;
